...
<head>
    ...
    <title>Login - WUDI Monitoring</title>
...
<body class="bg-[#fffcf6] min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8 font-sans">
        ...
        <div class="md:col-span-6 flex flex-col justify-between p-8 sm:p-12 lg:p-16">
            ...
            <div class="my-auto max-w-md w-full mx-auto space-y-6">
                <div class="text-center space-y-2">
                    <h1 class="text-3xl font-extrabold tracking-tight text-gray-900">Welcome Back to WUDI</h1>
                ...
                <form id="login-form" class="space-y-4">
                    <!-- Email field -->
                    <div class="space-y-1">
                        <label for="email" class="text-xs font-bold text-gray-700 uppercase tracking-wider">Email</label>
                        <input
                            id="email"
                    ...
                    <div class="flex items-center justify-between text-sm">
                        <label class="flex items-center gap-2 text-gray-600">
                            <input type="checkbox" class="rounded border-gray-300 text-yellow-950 focus:ring-yellow-950" />
                            Remember me
                        </label>
                        <a href="#" class="font-semibold text-yellow-950 hover:underline">Forgot password</a>
                    </div>
                ...
                <div class="relative flex items-center justify-center">
                    ...
                    <span class="relative px-4 bg-white text-xs text-gray-400 font-bold uppercase tracking-wider">Or login with</span>
                </div>
                ...
                <p class="text-sm text-gray-600 text-center font-medium">
                    Don't have an account? <a href="/register" class="text-yellow-950 font-bold hover:underline">Register</a>
                </p>
            </div>
    ...
    <script>
        ...
        function triggerGoogleLogin() {
            // Callback for placeholder button if GOOGLE_CLIENT_ID is empty
        ...
        loginForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (res.ok) {
                    ...
                    if (data.status === 'email_not_verified' || res.status === 403) {
                        setTimeout(() => {
